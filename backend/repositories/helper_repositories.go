...
func NewMyRequestsRepository(ctx context.Context, db interfaces.DB) interfaces.MyRequestsRepository {
...
func NewReportRepository(ctx context.Context, db interfaces.DB) interfaces.ReportRepository {
...
func (r *reportRepository) GetRequestStatusDistribution(ctx context.Context) (map[string]int, error) {
	...
	return result, utils.MapPgError(rows.Err())
}
...
func (r *holidayRepository) IsHoliday(ctx context.Context, date time.Time) (bool, error) {
	...
	return count > 0, utils.MapPgError(err)
}

func NewHolidayRepository(ctx context.Context, db interfaces.DB) interfaces.HolidayRepository {
